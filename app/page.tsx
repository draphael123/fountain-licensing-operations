  ...
  return (
    <main>
      <header className="topbar">
        <div className="brand"><span className="brand-mark">F</span><span>Licensing operations</span><span className="prototype">Synthetic prototype</span></div>
        <div className="access"><span className="lock">●</span><span>Private workspace</span><button className="avatar" aria-label="Account menu">DA</button></div>
      </header>
